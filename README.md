...
GO
<h3> Depois, deve ir no Projeto, na classe "clsConexao" na Linha 14 e mudar o caminho da conexão (Source), para o caminho de conexão do banco de sua máquina: </h3>
<div>
